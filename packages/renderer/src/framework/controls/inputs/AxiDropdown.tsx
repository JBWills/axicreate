...
function AxiDropdown<T extends unknown>({ label, onChange, options, value }: AxiDropdownProps<T>) {
  ...
  const renderOption = useCallback(
    (v: SelectOption<T> | undefined) => <div style={styles.dropdownOption}>{v?.displayName}</div>,
