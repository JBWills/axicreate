...
function AxiInputSwitch({ defaultValue, label, onChange, value }: AxiInputSwitchProps) {
  ...
  return (
    <div style={styles.axiInputSwitch}>
      ...
      <InputSwitch style={styles.inputSwitch} checked={actualValue} onChange={handleChange} />
    </div>
  )
}
